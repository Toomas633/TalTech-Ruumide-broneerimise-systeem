...
/*! Eesti keelne tõlge Toomas Kirsing */
"use strict";
(Date.prototype.getWeek = function (t) {
  ...
  (function (t) {
    ...
    var l = {
      ...
      d = { first_day: 1, week_numbers_iso_8601: !1, holidays: {} },
      h = {
        ...
        error_where:
          'Calendar: Wrong navigation direction {0}. Can be only "Järgmine" or "Eelmine" or "Täna"',
        error_timedevide:
          "Calendar: Time split parameter should divide 60 without decimals. Something like 10, 15, 30",
        no_events_in_day: "Üritused puuduvad",
        title_year: "{0}",
        title_month: "{0} {1}",
        ...
        time: "Aeg",
        events: "Üritus",
        before_time: "Lõppeb enne",
        after_time: "Algab pärast",
        m0: "Jaanuar",
        m1: "Veebruar",
        m2: "Märts",
        m3: "Aprill",
